...
public class StudentPortalGUI extends JFrame {
    ...
    public StudentPortalGUI() {
        ...
        Color textColor1 = Color.decode("#0099CC");
    ...
    private void login() {
        ...
        try (Connection conn = DatabaseConnector.connect()) {
            ...
            if (rs.next()) {
                ...
                /*JOptionPane.showMessageDialog(this, "Welcome " + firstName + " " + lastName + " (" + role + ")");*/

                openDashboard(firstName, lastName, role);
                this.dispose();
            } else {
    ...
    private void openDashboard(String firstName, String lastName, String role) {
        ...
        JLabel welcomeLabel = new JLabel("Welcome " + firstName + " " + lastName + " – " + role, SwingConstants.CENTER);
        ...
        switch (role) {
            ...
            case "Staff":
                ...
                panel.add(new JButton("Book Counselling"));
                break;
            case "Counsellor":
                panel.add(new JButton("View Appointments"));
                panel.add(new JButton("Update Status"));
                break;
            case "Admin":
                panel.add(new JButton("Manage Users"));
                panel.add(new JButton("View ALL Activies "));
                break;
        }
        dashboard.add(panel, BorderLayout.SOUTH);
